  ...
  */
  statics: {
    ...
    getCurrentPageNavbarVisibility() {
      if (
        ...
        this.currentPageNavbarVisibility =
          cv.TemplateEngine.getInstance().pagePartsHandler.getNavbarsVisibility(
            cv.TemplateEngine.getInstance().currentPage
          );
      }
    ...
    applyColumnWidths(selector, includeNavbars) {
      ...
      const mainAreaColspan = parseInt(
        mainAreaColumns || cv.Config.defaultColumns
      );
