    ...
    addStyles(styleArr) {
      ...
      queue.forEach(function (style) {
        if (typeof style === "string") {
          cv.util.ScriptLoader.includeStylesheet(
            qx.util.ResourceManager.getInstance().toUri(style) + suffix
          );
        } else if (typeof style === "object") {
          cv.util.ScriptLoader.includeStylesheet(
            qx.util.ResourceManager.getInstance().toUri(style.uri) + suffix,
            style.media
          );
        } else {
