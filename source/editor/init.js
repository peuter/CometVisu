...
$(document).ready(function () {
  ...
  $(document)
    .unbind("configuration_loaded")
    .bind("configuration_loaded", function () {
  ...
  $(document)
    .unbind("configuration_loading_error")
    .bind("configuration_loading_error", function (event, result) {
  ...
  $(document)
    .unbind("schema_loaded")
    .bind("schema_loaded", function () {
      try {
        config.setSchema(schema);
      } catch (e) {
        var tmpResult = new Result(
          false,
          Messages.validity.configurationInvalid,
          [e]
        );
  ...
  var configFilename =
    (isDemo ? "resource/demo/" : "resource/config/") +
    "visu_config" +
...
var GlobalConfigurationElementEventListener = {
   ...
   */
  ConfigurationElementEventListener(listenerEvent) {
