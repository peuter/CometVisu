...
var DataProviderManager = {
   ...
   */
  getProvider(elementName, attributeName) {
    ...
    if (typeof DataProviderManager._providers[elementName] === "undefined") {
      ...
      if (
        typeof DataProviderManager._providers["*"][attributeName] !==
        "undefined"
      ) {
    ...
    if (
      typeof DataProviderManager._providers[elementName][attributeName] !==
      "undefined"
    ) {
  ...
  initialize() {
    ...
    $.each(DataProviderConfig, function (elementName, subConfigs) {
      $.each(subConfigs, function (attributeName, config) {
        ...
        if (
          typeof DataProviderManager._providers[elementName] === "undefined"
        ) {
...
var DataProvider = function (config) {
  ...
  _provider.getEnumeration = function (element) {
    ...
    function createEnumeration(thisData) {
      ...
      if (
        typeof _providerConfig.grouped === "boolean" &&
        _providerConfig.grouped === true
      ) {
        var groupEnumerations = [];
        $.each(thisData, function (name, groupData) {
          groupEnumerations.push({
            label: name,
            elements: getEnumerationForData(groupData),
          });
        });
  ...
  _provider.preloadData = function () {
    var doCaching =
      typeof _providerConfig.cache !== "undefined"
        ? _providerConfig.cache
        : true;
      ...
      if (!getDataRunning) {
        ...
        $.ajax(_providerConfig.url, {
          ...
          success(result) {
            ...
            getDataCallbacks.forEach(function (callback) {
              callback(data);
            });
