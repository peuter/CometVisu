...
(function ($) {
  ...
  $.extend(SVGManager.prototype, {
    ...
    _afterLoad(container, svg, settings) {
  ...
  $.extend(SVGWrapper.prototype, {
    ...
    _args(values, names, optSettings) {
    ...
    symbol(parent, id, x1, y1, width, height, settings) {
    ...
    marker(parent, id, refX, refY, mWidth, mHeight, orient, settings) {
      var args = this._args(
        arguments,
    ...
    script(parent, script, type, settings) {
    ...
    _gradient(parent, name, settings, stops) {
    ...
    clipPath(parent, id, units, settings) {
    ...
    mask(parent, id, x, y, width, height, settings) {
    ...
    svg(parent, x, y, width, height, vx, vy, vwidth, vheight, settings) {
      var args = this._args(
        arguments,
    ...
    use(parent, x, y, width, height, ref, settings) {
    ...
    image(parent, x, y, width, height, ref, settings) {
      var args = this._args(arguments, ["x", "y", "width", "height", "ref"]);
      var node = this._makeNode(
        args.parent,
        "image",
    ...
    circle(parent, cx, cy, r, settings) {
    ...
    _poly(parent, name, points, settings) {
      var ps = "";
    ...
    textpath(parent, path, value, settings) {
    ...
    /** Draw text.
    	...
    	@param [settings] {object} Additional settings for this node.
    	@return {SVGElement} The new text node. */
    _text(parent, name, value, settings) {
      var node = this._makeNode(parent, name, settings);
    ...
    _makeNode(parent, name, settings) {
  ...
  $.extend(SVGPath.prototype, {
    ...
    /** Draw a cubic Bézier curve.
    	...
    	@param [relative=false] {boolean} <code>true</code> for coordinates relative to the current point,
    			<code>false</code> for coordinates being absolute.
    	@return {SVGPath} This path. */
    curveC(x1, y1, x2, y2, x, y, relative) {
    ...
    /** Draw an arc to a position.
    	...
    	@param [relative=false] {boolean} <code>true</code> for coordinates relative to the current point,
    			<code>false</code> for coordinates being absolute.
    	@return {SVGPath} This path. */
    arc(rx, ry, xRotate, large, clockwise, x, y, relative) {
