    ...
    (c.prototype.stringFormat = function (a, b) {
      ...
      if (
        ...
        "undefined" != typeof b.series.percent &&
          (a = this.adjustValPrecision(e, a, b.series.percent)),
        (a =
        ...
        this.isTimeMode("xaxis", b) &&
          ...
          (a = a.replace(
            g,
            this.timestampToDate(c, this.tooltipOptions.xDateFormat)
          )),
        this.isTimeMode("yaxis", b) &&
          this.isYDateFormat(b) &&
          (a = a.replace(
            h,
            this.timestampToDate(d, this.tooltipOptions.yDateFormat)
          )),
        ...
        "undefined" != typeof b.series.xaxis.ticks &&
          b.series.xaxis.ticks.length > b.dataIndex &&
          !this.isTimeMode("xaxis", b) &&
          (a = a.replace(g, b.series.xaxis.ticks[b.dataIndex].label)),
        "undefined" != typeof b.series.yaxis.ticks)
      )
        for (var k in b.series.yaxis.ticks)
          if (b.series.yaxis.ticks.hasOwnProperty(k)) {
            var l = this.isCategoriesMode("yaxis", b)
              ? b.series.yaxis.ticks[k].label
              : b.series.yaxis.ticks[k].v;
            l === d && (a = a.replace(h, b.series.yaxis.ticks[k].label));
          }
      return (
