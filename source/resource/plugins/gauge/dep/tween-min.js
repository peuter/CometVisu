...
(t.obj = {}),
  ...
  (t.broadcastMessage = function () {
    for (
      var i = [], r, t = this._listeners, u = t.length, n = 0;
      n < arguments.length;
      n++
    )
      i.push(arguments[n]);
  ...
  (Tween.backEaseInOut = function (n, t, i, r) {
    var u = 1.70158;
    return (n /= r / 2) < 1
      ? (i / 2) * n * n * (((u *= 1.525) + 1) * n - u) + t
      : (i / 2) * ((n -= 2) * n * (((u *= 1.525) + 1) * n + u) + 2) + t;
  }),
  (Tween.elasticEaseIn = function (n, t, i, r, u, f) {
    ...
    return n === 0
      ...
      : (f || (f = r * 0.3),
        !u || u < Math.abs(i)
          ? ((u = i), (e = f / 4))
          : (e = (f / (2 * Math.PI)) * Math.asin(i / u)),
        -(
          u *
          Math.pow(2, 10 * (n -= 1)) *
          Math.sin(((n * r - e) * 2 * Math.PI) / f)
        ) + t);
  }),
    ...
    return n === 0
      ...
      : (f || (f = r * 0.3),
        !u || u < Math.abs(i)
          ? ((u = i), (e = f / 4))
          : (e = (f / (2 * Math.PI)) * Math.asin(i / u)),
        u * Math.pow(2, -10 * n) * Math.sin(((n * r - e) * 2 * Math.PI) / f) +
          i +
          t);
  }),
  ...
  (Tween.bounceEaseOut = function (n, t, i, r) {
    return (n /= r) < 1 / 2.75
      ? i * 7.5625 * n * n + t
      : n < 2 / 2.75
      ? i * (7.5625 * (n -= 1.5 / 2.75) * n + 0.75) + t
      : n < 2.5 / 2.75
      ? i * (7.5625 * (n -= 2.25 / 2.75) * n + 0.9375) + t
      : i * (7.5625 * (n -= 2.625 / 2.75) * n + 0.984375) + t;
  }),
  ...
  (Tween.bounceEaseInOut = function (n, t, i, r) {
    return n < r / 2
      ? Tween.bounceEaseIn(n * 2, 0, i, r) * 0.5 + t
      : Tween.bounceEaseOut(n * 2 - r, 0, i, r) * 0.5 + i * 0.5 + t;
  }),
