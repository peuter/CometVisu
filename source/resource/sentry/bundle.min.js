...
var Sentry = (function (t) {
  ...
  function D(t) {
    var n =
      "string" == typeof t
        ? (function (t) {
            var n = k.exec(t);
            if (!n) throw new j("Invalid Sentry Dsn: " + t);
            var r = u(n.slice(1), 6),
              i = r[0],
              e = r[1],
              o = r[2],
  ...
  function B(t, n) {
    var r = n.prototype || {};
    (t.prototype = n.prototype = r), X(t, "__sentry_original__", n);
  }
  function W(t) {
  ...
  function Y(t, n) {
    ...
    if (r[0].length >= n) return J(r[0], n);
    for (var i = r.length; i > 0; i--) {
      var e = r.slice(0, i).join(", ");
      if (!(e.length > n)) return i === r.length ? e : J(e, n);
    }
    return "";
  }
  function Z(t) {
            ...
            et.document.addEventListener("click", n, !1),
              ...
              ["EventTarget", "Node"].forEach(function (n) {
                ...
                r &&
                  ...
                  (P(r, "addEventListener", function (n) {
                  ...
                  P(r, "removeEventListener", function (t) {
              ...
              return function () {
                ...
                return (
                  ...
                  "function" == typeof i.onreadystatechange
                    ? P(i, "onreadystatechange", function (t) {
                        return function () {
                          for (var n = [], r = 0; r < arguments.length; r++)
                            n[r] = arguments[r];
        ...
        case "history":
          !(function () {
            ...
            (et.onpopstate = function () {
              ...
              P(et.history, "pushState", n),
              P(et.history, "replaceState", n);
          })();
          break;
        case "error":
          (pt = et.onerror),
    ...
    return {
      ...
      add(i) {
        if (!(void 0 === t || n.length < t))
          return jt(new j("Not adding Promise due to buffer limit reached."));
        var e = i();
        return (
  ...
  var qt = (function () {
    ...
    return (
      ...
      (t.prototype.addBreadcrumb = function (t, n) {
        ...
        return (this.j = a(this.j, [i]).slice(-r)), this.L(), this;
      }),
    ...
    Ut = (function () {
      ...
      return (
        ...
        (t.prototype.captureException = function (t, n) {
          ...
          return this.X("captureException", t, e(e({}, i), { event_id: r })), r;
        }),
        (t.prototype.captureMessage = function (t, n, r) {
          ...
          return (
            this.X("captureMessage", t, n, e(e({}, o), { event_id: i })), i
          );
        }),
        (t.prototype.captureEvent = function (t, n) {
          var r = mt();
          return (
            "transaction" !== t.type && (this.P = r),
            this.X("captureEvent", t, e(e({}, n), { event_id: r })),
            r
          );
        }),
  ...
  function Ft() {
    var t,
      n = Jt();
    return (
      ((t = n) && t.__SENTRY__ && t.__SENTRY__.hub && !Pt(n).isOlderThan(4)) ||
        Xt(n, new Ut()),
      Pt(n)
    );
  }
  function Pt(t) {
    return (
      (t && t.__SENTRY__ && t.__SENTRY__.hub) ||
        ((t.__SENTRY__ = t.__SENTRY__ || {}), (t.__SENTRY__.hub = new Ut())),
      t.__SENTRY__.hub
    );
  }
  function Xt(t, n) {
    ...
    nn = (function () {
      ...
      return (
        ...
        (t.prototype.captureEvent = function (t, n, r) {
          if (!(n && n.originalException && St(n.originalException))) {
            var i = n && n.event_id;
            return (
              this.tt(
        ...
        (t.prototype.setupIntegrations = function () {
          this.it() && !this.G.initialized && (this.G = Zt(this.Y));
        }),
        (t.prototype.getIntegration = function (t) {
          try {
        ...
        (t.prototype.at = function (t, n, r) {
          ...
          this.ct(a), this.st(a);
          var c = n;
          r && r.captureContext && (c = qt.clone(c).update(r.captureContext));
          var s = _t(a);
          return (
        ...
        (t.prototype.ct = function (t) {
          ...
          "environment" in t ||
            ...
            t.message && (t.message = J(t.message, u));
          var a = t.exception && t.exception.values && t.exception.values[0];
          a && a.value && (a.value = J(a.value, u));
          var c = t.request;
          c && c.url && (c.url = J(c.url, u));
        }),
        ...
        (t.prototype.vt = function (t, n, r) {
          ...
          if (!this.it())
            return jt(new j("SDK not enabled, will not capture event."));
  ...
  var pn =
    ...
    mn = function (t) {
      ...
      if (n) {
        ...
        var i = u(On(n[1] || dn, n[2]), 2),
          e = i[0];
        return ln(i[1], e, n[3] ? +n[3] : void 0, n[4] ? +n[4] : void 0);
      }
    },
    bn =
    ...
    gn = function (t) {
      ...
      if (r) {
        ...
        return (
          (o = (n = u(On(o, e), 2))[0]),
          ln((e = n[1]), o, r[4] ? +r[4] : void 0, r[5] ? +r[5] : void 0)
        );
      }
    },
    xn =
    ...
    En = function (t) {
      var n = xn.exec(t);
      return n ? ln(n[2], n[1] || dn, +n[3], n[4] ? +n[4] : void 0) : void 0;
    },
    Sn = / line (\d+).*script (?:in )?(\S+)(?:: in function (\S+))?$/i,
    _n = function (t) {
      var n = Sn.exec(t);
      return n ? ln(n[2], n[3] || dn, +n[1]) : void 0;
    },
    jn =
      / line (\d+), column (\d+)\s*(?:in (?:<anonymous function: ([^>]+)>|([^)]+))\(.*\))? in (.*):\s*$/i,
    kn = function (t) {
      var n = jn.exec(t);
      return n ? ln(n[5], n[3] || n[4] || dn, +n[1], +n[2]) : void 0;
    },
    On = function (t, n) {
  ...
  function Mn(n, r, i) {
    var e = An(r, (i && i.syntheticException) || void 0, {
  ...
  function qn(n, r, i, e) {
    ...
    var o = Cn(r, (e && e.syntheticException) || void 0, {
      attachStacktrace: n.attachStacktrace,
    });
    return (o.level = i), e && e.event_id && (o.event_id = e.event_id), _t(o);
  }
  function An(t, n, r) {
    var i;
    if ((void 0 === r && (r = {}), d(t) && t.error)) return Dn(t.error);
    if (l(t) || v(t, "DOMException")) {
      var o = t;
      if ("stack" in t) i = Dn(t);
      else {
        var u = o.name || (l(o) ? "DOMError" : "DOMException"),
    ...
    return h(t)
      ...
      ? ((i = (function (t, n, r) {
          ...
          return n && (i.stacktrace = { frames: Nn(n) }), i;
        })(t, n, r.isRejection)),
        Et(i, { synthetic: !0 }),
        i)
      : (xt((i = Cn(t, n, r)), "" + t, void 0), Et(i, { synthetic: !0 }), i);
  }
  function Cn(t, n, r) {
    void 0 === r && (r = {});
    var i = { message: t };
    return r.attachStacktrace && n && (i.stacktrace = { frames: Nn(n) }), i;
  }
  var Ln,
    Un = s();
  function Jn() {
    if (Ln) return Ln;
    if (nt(Un.fetch)) return (Ln = Un.fetch.bind(Un));
    var t = Un.document,
      n = Un.fetch;
      ...
      function t(t) {
        ...
        (this.options = t),
          ...
          this.options.sendClientReports &&
            Pn.document &&
            Pn.document.addEventListener("visibilitychange", function () {
              "hidden" === Pn.document.visibilityState && e.Nt();
            });
      }
      return (
        (t.prototype.sendEvent = function (t) {
        ...
        (t.prototype.recordLostEvent = function (t, n) {
          ...
          if (this.options.sendClientReports) {
            ...
            A.log("Adding outcome: " + i),
              (this.Ot[i] = (null != (r = this.Ot[i]) ? r : 0) + 1);
          }
        }),
        (t.prototype.Nt = function () {
          if (this.options.sendClientReports) {
            ...
            if (((this.Ot = {}), Object.keys(t).length)) {
              ...
              var n = Vt(this.Tt.dsn, this.Tt.tunnel),
                r =
                  JSON.stringify(
                    e({}, this.Tt.tunnel && { dsn: O(this.Tt.dsn) })
                  ) +
                  "\n" +
    ...
    zn = (function (n) {
      ...
      return (
        ...
        (i.prototype.eventFromException = function (t, n) {
          return Mn(this.Y, t, n);
        }),
        (i.prototype.eventFromMessage = function (n, r, i) {
          return void 0 === r && (r = t.Severity.Info), qn(this.Y, n, r, i);
        }),
  ...
  function Yn(t, n, r) {
    ...
    B(sentryWrapped, t), X(t, "__sentry_wrapped__", sentryWrapped);
    try {
  ...
  function Zn(t) {
    if ((void 0 === t && (t = {}), Gn.document && t.eventId && t.dsn)) {
      var n = Gn.document.createElement("script");
      (n.async = !0),
        (n.src = (function (t, n) {
          var r = D(t),
            i = $t(r) + "embed/error-page/",
            e = "dsn=" + O(r);
          for (var o in n)
            if ("dsn" !== o)
              if ("user" === o) {
      ...
      var r = Gn.document.head || Gn.document.body;
      r && r.appendChild(n);
    }
  }
  var tr = (function () {
    function t(n) {
      (this.name = t.id),
        (this.Lt = { onerror: nr, onunhandledrejection: rr }),
        ...
        if (!(Vn() || (f && f.__sentry_own_request__))) {
          var h =
            void 0 === f && p(o)
              ...
              : ir(
                  An(f || o, void 0, { attachStacktrace: e, isRejection: !1 }),
                  a,
                  c,
                  s
                );
          (h.level = t.Severity.Error), or(i, f, h, "onerror");
        }
      }
    });
  }
    ...
    ct("unhandledrejection", function (n) {
      ...
      if (i.getIntegration(tr)) {
        ...
        var a = y(o)
          ...
          : An(o, void 0, { attachStacktrace: e, isRejection: !0 });
        (a.level = t.Severity.Error), or(i, o, a, "onunhandledrejection");
      }
    });
  }
  function ir(t, n, r, i) {
  ...
  var ar = [
    ...
    cr = (function () {
      ...
      return (
        (t.prototype.setupOnce = function () {
          var t = s();
          this.Y.setTimeout && P(t, "setTimeout", sr),
            this.Y.setInterval && P(t, "setInterval", sr),
            this.Y.requestAnimationFrame && P(t, "requestAnimationFrame", fr),
            this.Y.XMLHttpRequest &&
              "XMLHttpRequest" in t &&
              P(XMLHttpRequest.prototype, "send", hr);
          var n = this.Y.eventTarget;
          n && (Array.isArray(n) ? n : ar).forEach(vr);
        }),
        (t.id = "TryCatch"),
        t
      );
          ...
          t in i &&
            ...
            P(i, t, function (n) {
              var r = {
                ...
                i = W(n);
              return i && (r.mechanism.data.handler = U(i)), Yn(n, r);
            });
        }),
        t.apply(this, n)
      );
        ...
        return function (r, i, e) {
          try {
            "function" == typeof i.handleEvent &&
              (i.handleEvent = Yn(i.handleEvent.bind(i), {
                mechanism: {
    ...
    return (
      ...
      (t.prototype.setupOnce = function () {
        this.Y.console && ct("console", lr),
          ...
          this.Y.xhr && ct("xhr", pr),
          this.Y.fetch && ct("fetch", yr),
          this.Y.history && ct("history", mr);
      }),
      (t.id = "Breadcrumbs"),
      t
    );
  ...
  function mr(t) {
    ...
    o.path || (o = e),
      ...
      Ft().addBreadcrumb({ category: "navigation", data: { from: r, to: i } });
  }
  var br = (function () {
    function t(n) {
      void 0 === n && (n = {}),
      ...
      return (
        ...
        (n.prototype.showReportDialog = function (t) {
          void 0 === t && (t = {}),
            s().document &&
              (this.it()
                ? Zn(e(e({}, t), { dsn: t.dsn || this.getDsn() }))
                : A.error(
  ...
  return (
    ...
    (t.init = function (t) {
      if (
        (void 0 === t && (t = {}),
        void 0 === t.defaultIntegrations && (t.defaultIntegrations = Dr),
        void 0 === t.release)
      ) {
        var n = s();
        n.SENTRY_RELEASE &&
    ...
    (t.startTransaction = function (t, n) {
      return Bt("startTransaction", e({}, t), n);
    }),
    (t.withScope = Wt),
    (t.wrap = function (t) {
      return Yn(t)();
