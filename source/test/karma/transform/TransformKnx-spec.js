...
var testcases = [
  ...
  {
    transform: "DPT:10.001",
    type: "encode",
    source: new Date(0, 0, 0, 0, 0, 0),
    target: "80000000",
    noNumber: true,
  },
  {
  ...
  },
  {
    ...
    type: "decode",
    source: "400000",
    target: targetTime(2, 0, 0, 0),
    isDate: true,
  },

  {
    transform: "DPT:11.001",
    type: "decode",
    source: "01015a",
    target: targetDate(1, 1, 1990),
    isDate: true,
  },
  {
    transform: "DPT:11.001",
  ...
  {
    transform: "DPT:14.001",
    type: "decode",
    source: "00000000",
    target: Math.pow(2, -127),
  },
  ...
  {
    transform: "DPT:16.001",
    type: "encode",
    source: "",
    target: "800000000000000000000000000000",
    noNumber: true,
  },
  {
    transform: "DPT:16.001",
    type: "encode",
    source: "abc",
    target: "806162630000000000000000000000",
    noNumber: true,
  },
  {
    transform: "DPT:16.001",
    ...
    target: "806162636465666768696a6b6c6d6e",
    noNumber: true,
  },
  {
    transform: "DPT:16.001",
    type: "decode",
    source: "0000000000000000000000000000",
    target: "",
  },
  {
    transform: "DPT:16.001",
    type: "decode",
    source: "6162630000000000000000000000",
    target: "abc",
  },
  {
    transform: "DPT:16.001",
    type: "decode",
    source: "6162636465666768696a6b6c6d6e",
  ...
  { transform: "DPT:20.102", type: "decode", source: "03", target: "economy" },
  {
    ...
    type: "decode",
    source: "04",
    target: "building_protection",
  },

  {
    transform: "DPT:24.001",
    type: "encode",
    source: "Test string",
    target: "805465737420737472696e6700",
    noNumber: true,
  },
  {
    transform: "DPT:24.001",
    type: "decode",
    source: "5465737420737472696e67",
    target: "Test string",
  },
  ...
  {
    transform: "DPT:242.600",
    type: "encode",
    source: "foo",
    target: "80000000000000",
    noNumber: true,
  }, // test misuse robustness
  {
    transform: "DPT:242.600",
    type: "encode",
    source: 0,
    target: "80000000000001",
  }, // test misuse robustness
  {
    transform: "DPT:242.600",
    type: "encode",
...
describe("checking knx transforms", function () {
  ...
  testcases.forEach(function (testcase, index) {
    const source =
      testcase.source instanceof Map
        ? JSON.stringify(Object.fromEntries([...testcase.source]))
        : testcase.source;
    it(
      "should transform " +
        testcase.transform +
      ...
      function () {
        switch (testcase.type) {
          case "encode":
            // test direct
            expect(cv.Transform.encode(testcase, testcase.source)).toEqual(
              testcase.target
            );
            if (!testcase.noNumber) {
              ...
              if (!testcase.noInt) {
                expect(
                  cv.Transform.encode(testcase, testcase.source | 0)
                ).toEqual(testcase.target);
              }
              // test float
              expect(cv.Transform.encode(testcase, +testcase.source)).toEqual(
                testcase.target
              ...
              // test string
              expect(
                cv.Transform.encode(testcase, testcase.source + "")
              ).toEqual(testcase.target);
            }
            break;
          ...
          case "decode":
            if (testcase.isDate) {
              expect(
                cv.Transform.decode(testcase, testcase.source) + ""
              ).toEqual(testcase.target + "");
            } else {
              expect(cv.Transform.decode(testcase, testcase.source)).toEqual(
                testcase.target
              );
            }
            break;
