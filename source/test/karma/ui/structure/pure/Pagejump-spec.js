...
describe("testing a pagejump widget", function () {
  ...
  it("should test the scrolltopage listener", function () {
    ...
    qx.event.message.Bus.subscribe(
      "path.pageChanged",
      cv.ui.structure.pure.PageJump._onScrollToPage,
      cv.ui.structure.pure.PageJump
    );

    var returns = ["id_1_0", "id_1"];
    spyOn(cv.ui.structure.WidgetFactory, "getInstanceById").and.callFake(
      function () {
    ...
    this.initWidget(creator);
    spyOn(cv.data.Model.getInstance(), "getWidgetDataByElement").and.callFake(
      function () {
