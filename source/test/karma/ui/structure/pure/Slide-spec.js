...
describe("testing a slide widget", function () {
  ...
  it("should test the min/max and step settings", function () {
    var widgetInstance = this.createTestElement("slide", {
      min: 30,
      max: 130,
      step: 5,
    });
  ...
  it("should test the min/max settings from transform", function () {
    var widgetInstance = this.createTestElement("slide", {}, null, null, {
      transform: "DPT:5.004",
    });
  ...
  it("should not re-send incoming data", function () {
    var widgetInstance = this.createTestElement(
      ...
      [
        { transform: "DPT:5.004", mode: "read" },
        { transform: "DPT:5.004", mode: "write" },
      ]
    );
    this.initWidget(widgetInstance);
