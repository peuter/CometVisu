...
describe("testing a trigger", function () {
  ...
  it("should trigger the trigger shortpress", function (done) {
    ...
    // down
    var nativeEvent = new window.PointerEvent(
      "pointerdown",
    ...
    Reg.fireEvent(actor, "pointerdown", qx.event.type.Pointer, [
      nativeEvent,
      actor,
      actor,
      true,
    ...
    setTimeout(function () {
      // up
      nativeEvent = new window.PointerEvent(
        "pointerup",
        Object.assign(eventData, {
          type: "pointerup",
        })
      ...
      Reg.fireEvent(actor, "pointerup", qx.event.type.Pointer, [
        nativeEvent,
        actor,
        actor,
        true,
